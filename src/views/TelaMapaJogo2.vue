...
/>
      ...
      <SequenciaDiaria :visible="showPopup" @close="showPopup = false" />
    </div>
  </template>
  
  <script>
  import SequenciaDiaria from '../components/SequenciaDiaria.vue';
  ...
  svg {
    ...
    min-width: 2400px; /* Garantir que a largura mínima do SVG seja suficiente */
  }
